...
- [x] Discuss about design choices
  - [x] Primary Color
  - [x] Fonts
- [x] Make decisions about minor styles
  - [x] hover action

### Implementation
- [ ] Map Page
  - [ ] a button to bring back to current location
  - [ ] a button to exit 'locate' mode
  - [ ] style tag container
  - [x] add Google Map
  - [x] Bin Details Modal
  - [x] Add Bin Modal
...
- [ ] Profile Page
  - [x] Profile Display
  - [x] Statistics
  - [ ] Edit Profile *should we just cur it out?*
- [ ] Authentication
  - [x] Logout (should be in Profile page)
  - [x] Login
  - [x] Signup
  - [x] Session
- [x] Menu Bar
  - [x] Extended Menu Trigger
  - [x] Layout
